    ...
    {{csrf_field()}}
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="" name="name" type="text" placeholder="账户" class="input-text size-L" value="{{old('name')}}">
          <span><font color="red">{{$errors->Error->first("name")}}</font></span>
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          ...
          <span><font color="red">{{$errors->Error->first('pwd')}}</font></span>
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <span><font color="red">{{$errors->Error->first('cod')}}</font></span>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
